...
if __name__ == '__main__':
    ...
    for x in range(1):
        ...
        edge_cloud_architectures = [2, 3, 6, 9]
        edge_cloud_resources = [E1, E2, E3, C1, C2, C3]
        ...
        pj, rC, total_rC, best_eval_D, scores = optimize_offloading(p.n_iterations, p.n_iterations_cost, temp,
                                                          edge_cloud_architectures, edge_cloud_resources)
        ...
        d = [['edge-cloud', pj[0], pj[1], pj[2], pj[3], pj[4], pj[5], pj[6], pj[7], pj[8], pj[9],total_rC,
